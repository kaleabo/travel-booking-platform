...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    images: ["https://ease-travel.vercel.app/og-image.png"],
    site: "@kaleabox",
    creator: "@kaleabox",
  },
  robots: "index, follow",
